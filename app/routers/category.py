...
async def create_category(
    ...
    # print(create_cpostgres+asyncpg://ecommerce:ecommerce@0.0.0.0:5433/ecommerceategory)
...
async def update_category(
    ...
    if get_user.get('is_admin'):
        ...
        return HTTPException(status_code=status.HTTP_403_FORBIDDEN, detail='You must be admin user for this')
